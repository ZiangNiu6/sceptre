...
Rcpp::List crt_empirical_spa_full_cpp(const Rcpp::NumericVector& a, const Rcpp::NumericVector& propensity, const double target, const int score_sign, const double tolerance, const int max_iterations, const int max_backtracks);
RcppExport SEXP _sceptre_crt_empirical_spa_full_cpp(SEXP aSEXP, SEXP propensitySEXP, SEXP targetSEXP, SEXP score_signSEXP, SEXP toleranceSEXP, SEXP max_iterationsSEXP, SEXP max_backtracksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(crt_empirical_spa_full_cpp(a, propensity, target, score_sign, tolerance, max_iterations, max_backtracks));
    return rcpp_result_gen;
END_RCPP
}
// crt_empirical_spa_full_fast_cpp
Rcpp::List crt_empirical_spa_full_fast_cpp(const Rcpp::NumericVector& a, const Rcpp::NumericVector& propensity, const Rcpp::NumericVector& y, const double target, const int score_sign, const double tolerance, const int max_iterations, const int max_backtracks);
RcppExport SEXP _sceptre_crt_empirical_spa_full_fast_cpp(SEXP aSEXP, SEXP propensitySEXP, SEXP ySEXP, SEXP targetSEXP, SEXP score_signSEXP, SEXP toleranceSEXP, SEXP max_iterationsSEXP, SEXP max_backtracksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type max_iterations(max_iterationsSEXP);
    Rcpp::traits::input_parameter< const int >::type max_backtracks(max_backtracksSEXP);
    rcpp_result_gen = Rcpp::wrap(crt_empirical_spa_full_fast_cpp(a, propensity, y, target, score_sign, tolerance, max_iterations, max_backtracks));
    return rcpp_result_gen;
END_RCPP
}
// crt_spa_full_cpp
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type tolerance(toleranceSEXP);
    Rcpp::traits::input_parameter< const int >::type max_iterations(max_iterationsSEXP);
    rcpp_result_gen = Rcpp::wrap(crt_spa_full_fast_cpp(a, w, y, Z, propensity, target, score_sign, tolerance, max_iterations));
    return rcpp_result_gen;
END_RCPP
}
// crt_spa_full_outward_fast_cpp
Rcpp::List crt_spa_full_outward_fast_cpp(const Rcpp::NumericVector& a, const Rcpp::NumericVector& w, const Rcpp::NumericVector& y, const Rcpp::NumericMatrix& Z, const Rcpp::NumericVector& propensity, const Rcpp::IntegerVector& treated_indices, const double tolerance, const int max_iterations);
RcppExport SEXP _sceptre_crt_spa_full_outward_fast_cpp(SEXP aSEXP, SEXP wSEXP, SEXP ySEXP, SEXP ZSEXP, SEXP propensitySEXP, SEXP treated_indicesSEXP, SEXP toleranceSEXP, SEXP max_iterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type tolerance(toleranceSEXP);
    Rcpp::traits::input_parameter< const int >::type max_iterations(max_iterationsSEXP);
    rcpp_result_gen = Rcpp::wrap(crt_spa_full_outward_fast_cpp(a, w, y, Z, propensity, treated_indices, tolerance, max_iterations));
    return rcpp_result_gen;
END_RCPP
}
...
// finalize_low_level_test_crt_spa_fallback_v1
SEXP finalize_low_level_test_crt_spa_fallback_v1(NumericVector a, NumericVector w, NumericMatrix Z, SEXP synthetic_idxs, int B2, bool return_resampling_dist, int side_code, List spa_attempt_result);
RcppExport SEXP _sceptre_finalize_low_level_test_crt_spa_fallback_v1(SEXP aSEXP, SEXP wSEXP, SEXP ZSEXP, SEXP synthetic_idxsSEXP, SEXP B2SEXP, SEXP return_resampling_distSEXP, SEXP side_codeSEXP, SEXP spa_attempt_resultSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type return_resampling_dist(return_resampling_distSEXP);
    Rcpp::traits::input_parameter< int >::type side_code(side_codeSEXP);
    Rcpp::traits::input_parameter< List >::type spa_attempt_result(spa_attempt_resultSEXP);
    rcpp_result_gen = Rcpp::wrap(finalize_low_level_test_crt_spa_fallback_v1(a, w, Z, synthetic_idxs, B2, return_resampling_dist, side_code, spa_attempt_result));
    return rcpp_result_gen;
END_RCPP
}
// compute_observed_empirical_crt_statistic_v1
double compute_observed_empirical_crt_statistic_v1(const NumericVector& a, const NumericVector& fitted_probabilities, const IntegerVector& trt_idxs);
RcppExport SEXP _sceptre_compute_observed_empirical_crt_statistic_v1(SEXP aSEXP, SEXP fitted_probabilitiesSEXP, SEXP trt_idxsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector& >::type a(aSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type fitted_probabilities(fitted_probabilitiesSEXP);
    Rcpp::traits::input_parameter< const IntegerVector& >::type trt_idxs(trt_idxsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_observed_empirical_crt_statistic_v1(a, fitted_probabilities, trt_idxs));
    return rcpp_result_gen;
END_RCPP
}
// compute_null_empirical_crt_statistics_v1
std::vector<double> compute_null_empirical_crt_statistics_v1(const NumericVector& a, const NumericVector& fitted_probabilities, const int start_pos, const int B, SEXP synthetic_idxs);
RcppExport SEXP _sceptre_compute_null_empirical_crt_statistics_v1(SEXP aSEXP, SEXP fitted_probabilitiesSEXP, SEXP start_posSEXP, SEXP BSEXP, SEXP synthetic_idxsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector& >::type a(aSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type fitted_probabilities(fitted_probabilitiesSEXP);
    Rcpp::traits::input_parameter< const int >::type start_pos(start_posSEXP);
    Rcpp::traits::input_parameter< const int >::type B(BSEXP);
    Rcpp::traits::input_parameter< SEXP >::type synthetic_idxs(synthetic_idxsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_null_empirical_crt_statistics_v1(a, fitted_probabilities, start_pos, B, synthetic_idxs));
    return rcpp_result_gen;
END_RCPP
}
...
// finalize_low_level_test_empirical_crt_fallback_v1
SEXP finalize_low_level_test_empirical_crt_fallback_v1(NumericVector a, NumericVector fitted_probabilities, SEXP synthetic_idxs, int B2, bool return_resampling_dist, int side_code, List spa_attempt_result);
RcppExport SEXP _sceptre_finalize_low_level_test_empirical_crt_fallback_v1(SEXP aSEXP, SEXP fitted_probabilitiesSEXP, SEXP synthetic_idxsSEXP, SEXP B2SEXP, SEXP return_resampling_distSEXP, SEXP side_codeSEXP, SEXP spa_attempt_resultSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type side_code(side_codeSEXP);
    Rcpp::traits::input_parameter< List >::type spa_attempt_result(spa_attempt_resultSEXP);
    rcpp_result_gen = Rcpp::wrap(finalize_low_level_test_empirical_crt_fallback_v1(a, fitted_probabilities, synthetic_idxs, B2, return_resampling_dist, side_code, spa_attempt_result));
    return rcpp_result_gen;
END_RCPP
}
...
SEXP run_low_level_test_full_rpt_spa_v1(NumericVector y, NumericVector mu, NumericVector a, NumericVector w, NumericMatrix D, NumericMatrix Z, IntegerVector trt_idxs, int n_trt, bool use_all_cells, SEXP synthetic_idxs, int B1, int B2, bool return_resampling_dist, int side_code, bool use_moment, SEXP prepared_context);
RcppExport SEXP _sceptre_run_low_level_test_full_rpt_spa_v1(SEXP ySEXP, SEXP muSEXP, SEXP aSEXP, SEXP wSEXP, SEXP DSEXP, SEXP ZSEXP, SEXP trt_idxsSEXP, SEXP n_trtSEXP, SEXP use_all_cellsSEXP, SEXP synthetic_idxsSEXP, SEXP B1SEXP, SEXP B2SEXP, SEXP return_resampling_distSEXP, SEXP side_codeSEXP, SEXP use_momentSEXP, SEXP prepared_contextSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type return_resampling_dist(return_resampling_distSEXP);
    Rcpp::traits::input_parameter< int >::type side_code(side_codeSEXP);
    Rcpp::traits::input_parameter< bool >::type use_moment(use_momentSEXP);
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    rcpp_result_gen = Rcpp::wrap(run_low_level_test_full_rpt_spa_v1(y, mu, a, w, D, Z, trt_idxs, n_trt, use_all_cells, synthetic_idxs, B1, B2, return_resampling_dist, side_code, use_moment, prepared_context));
    return rcpp_result_gen;
END_RCPP
}
// run_low_level_test_full_rpt_spa_always_v1
SEXP run_low_level_test_full_rpt_spa_always_v1(NumericVector y, NumericVector mu, NumericVector a, NumericVector w, NumericMatrix Z, IntegerVector trt_idxs, int n_trt, int side_code, int max_iterations, bool use_moment, SEXP prepared_context);
RcppExport SEXP _sceptre_run_low_level_test_full_rpt_spa_always_v1(SEXP ySEXP, SEXP muSEXP, SEXP aSEXP, SEXP wSEXP, SEXP ZSEXP, SEXP trt_idxsSEXP, SEXP n_trtSEXP, SEXP side_codeSEXP, SEXP max_iterationsSEXP, SEXP use_momentSEXP, SEXP prepared_contextSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type use_moment(use_momentSEXP);
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    rcpp_result_gen = Rcpp::wrap(run_low_level_test_full_rpt_spa_always_v1(y, mu, a, w, Z, trt_idxs, n_trt, side_code, max_iterations, use_moment, prepared_context));
    return rcpp_result_gen;
END_RCPP
}
// finalize_low_level_test_rpt_spa_fallback_v1
SEXP finalize_low_level_test_rpt_spa_fallback_v1(NumericVector a, NumericVector w, NumericMatrix Z, int n_trt, SEXP synthetic_idxs, int B2, bool return_resampling_dist, int side_code, List spa_attempt_result);
RcppExport SEXP _sceptre_finalize_low_level_test_rpt_spa_fallback_v1(SEXP aSEXP, SEXP wSEXP, SEXP ZSEXP, SEXP n_trtSEXP, SEXP synthetic_idxsSEXP, SEXP B2SEXP, SEXP return_resampling_distSEXP, SEXP side_codeSEXP, SEXP spa_attempt_resultSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type side_code(side_codeSEXP);
    Rcpp::traits::input_parameter< List >::type spa_attempt_result(spa_attempt_resultSEXP);
    rcpp_result_gen = Rcpp::wrap(finalize_low_level_test_rpt_spa_fallback_v1(a, w, Z, n_trt, synthetic_idxs, B2, return_resampling_dist, side_code, spa_attempt_result));
    return rcpp_result_gen;
END_RCPP
}
...
// rpt_spa_full_cpp
Rcpp::List rpt_spa_full_cpp(const Rcpp::NumericVector& a, const Rcpp::NumericVector& w, const Rcpp::NumericMatrix& Z, const int m, const double target, const int score_sign, const double tolerance, const int max_iterations);
RcppExport SEXP _sceptre_rpt_spa_full_cpp(SEXP aSEXP, SEXP wSEXP, SEXP ZSEXP, SEXP mSEXP, SEXP targetSEXP, SEXP score_signSEXP, SEXP toleranceSEXP, SEXP max_iterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type tolerance(toleranceSEXP);
    Rcpp::traits::input_parameter< const int >::type max_iterations(max_iterationsSEXP);
    rcpp_result_gen = Rcpp::wrap(rpt_spa_full_cpp(a, w, Z, m, target, score_sign, tolerance, max_iterations));
    return rcpp_result_gen;
END_RCPP
}
// prepare_rpt_spa_response_cpp
SEXP prepare_rpt_spa_response_cpp(const Rcpp::NumericVector& a, const Rcpp::NumericVector& w, const Rcpp::NumericMatrix& Z, const Rcpp::LogicalVector& zero_mask, const double minimum_zero_fraction, const int maximum_moment_degree);
RcppExport SEXP _sceptre_prepare_rpt_spa_response_cpp(SEXP aSEXP, SEXP wSEXP, SEXP ZSEXP, SEXP zero_maskSEXP, SEXP minimum_zero_fractionSEXP, SEXP maximum_moment_degreeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type a(aSEXP);
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type w(wSEXP);
    Rcpp::traits::input_parameter< const Rcpp::NumericMatrix& >::type Z(ZSEXP);
    Rcpp::traits::input_parameter< const Rcpp::LogicalVector& >::type zero_mask(zero_maskSEXP);
    Rcpp::traits::input_parameter< const double >::type minimum_zero_fraction(minimum_zero_fractionSEXP);
    Rcpp::traits::input_parameter< const int >::type maximum_moment_degree(maximum_moment_degreeSEXP);
    rcpp_result_gen = Rcpp::wrap(prepare_rpt_spa_response_cpp(a, w, Z, zero_mask, minimum_zero_fraction, maximum_moment_degree));
    return rcpp_result_gen;
END_RCPP
}
// release_rpt_spa_response_cpp
void release_rpt_spa_response_cpp(SEXP prepared_context);
RcppExport SEXP _sceptre_release_rpt_spa_response_cpp(SEXP prepared_contextSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    release_rpt_spa_response_cpp(prepared_context);
    return R_NilValue;
END_RCPP
}
// rpt_spa_moment_null_evaluation_cpp
Rcpp::List rpt_spa_moment_null_evaluation_cpp(SEXP prepared_context, const int m, const int score_sign, const double target);
RcppExport SEXP _sceptre_rpt_spa_moment_null_evaluation_cpp(SEXP prepared_contextSEXP, SEXP mSEXP, SEXP score_signSEXP, SEXP targetSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type score_sign(score_signSEXP);
    Rcpp::traits::input_parameter< const double >::type target(targetSEXP);
    rcpp_result_gen = Rcpp::wrap(rpt_spa_moment_null_evaluation_cpp(prepared_context, m, score_sign, target));
    return rcpp_result_gen;
END_RCPP
}
// rpt_spa_moment_prepared_cpp
Rcpp::List rpt_spa_moment_prepared_cpp(SEXP prepared_context, const int m, const double target, const int score_sign, const double tolerance, const double compressed_tolerance, const int max_iterations, const int maximum_polish_updates, const double delta_limit, const double exact_audit_tolerance);
RcppExport SEXP _sceptre_rpt_spa_moment_prepared_cpp(SEXP prepared_contextSEXP, SEXP mSEXP, SEXP targetSEXP, SEXP score_signSEXP, SEXP toleranceSEXP, SEXP compressed_toleranceSEXP, SEXP max_iterationsSEXP, SEXP maximum_polish_updatesSEXP, SEXP delta_limitSEXP, SEXP exact_audit_toleranceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type score_sign(score_signSEXP);
    Rcpp::traits::input_parameter< const double >::type tolerance(toleranceSEXP);
    Rcpp::traits::input_parameter< const double >::type compressed_tolerance(compressed_toleranceSEXP);
    Rcpp::traits::input_parameter< const int >::type max_iterations(max_iterationsSEXP);
    Rcpp::traits::input_parameter< const int >::type maximum_polish_updates(maximum_polish_updatesSEXP);
    Rcpp::traits::input_parameter< const double >::type delta_limit(delta_limitSEXP);
    Rcpp::traits::input_parameter< const double >::type exact_audit_tolerance(exact_audit_toleranceSEXP);
    rcpp_result_gen = Rcpp::wrap(rpt_spa_moment_prepared_cpp(prepared_context, m, target, score_sign, tolerance, compressed_tolerance, max_iterations, maximum_polish_updates, delta_limit, exact_audit_tolerance));
    return rcpp_result_gen;
END_RCPP
}
// rpt_spa_moment_outward_prepared_cpp
Rcpp::List rpt_spa_moment_outward_prepared_cpp(SEXP prepared_context, const Rcpp::IntegerVector& treated_indices, const double tolerance, const double compressed_tolerance, const int max_iterations, const int maximum_polish_updates, const double delta_limit, const double exact_audit_tolerance);
RcppExport SEXP _sceptre_rpt_spa_moment_outward_prepared_cpp(SEXP prepared_contextSEXP, SEXP treated_indicesSEXP, SEXP toleranceSEXP, SEXP compressed_toleranceSEXP, SEXP max_iterationsSEXP, SEXP maximum_polish_updatesSEXP, SEXP delta_limitSEXP, SEXP exact_audit_toleranceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type prepared_context(prepared_contextSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type delta_limit(delta_limitSEXP);
    Rcpp::traits::input_parameter< const double >::type exact_audit_tolerance(exact_audit_toleranceSEXP);
    rcpp_result_gen = Rcpp::wrap(rpt_spa_moment_outward_prepared_cpp(prepared_context, treated_indices, tolerance, compressed_tolerance, max_iterations, maximum_polish_updates, delta_limit, exact_audit_tolerance));
    return rcpp_result_gen;
END_RCPP
}
// rpt_spa_count_profile_cpp
Rcpp::List rpt_spa_count_profile_cpp(const Rcpp::NumericVector& linear_predictor, const int m, const double initial);
RcppExport SEXP _sceptre_rpt_spa_count_profile_cpp(SEXP linear_predictorSEXP, SEXP mSEXP, SEXP initialSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type linear_predictor(linear_predictorSEXP);
    Rcpp::traits::input_parameter< const int >::type m(mSEXP);
    Rcpp::traits::input_parameter< const double >::type initial(initialSEXP);
    rcpp_result_gen = Rcpp::wrap(rpt_spa_count_profile_cpp(linear_predictor, m, initial));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sceptre_run_low_level_test_full_rpt_spa_v1", (DL_FUNC) &_sceptre_run_low_level_test_full_rpt_spa_v1, 16},
    {"_sceptre_run_low_level_test_full_rpt_spa_always_v1", (DL_FUNC) &_sceptre_run_low_level_test_full_rpt_spa_always_v1, 11},
    {"_sceptre_finalize_low_level_test_rpt_spa_fallback_v1", (DL_FUNC) &_sceptre_finalize_low_level_test_rpt_spa_fallback_v1, 9},
    ...
    {"_sceptre_rpt_spa_full_cpp", (DL_FUNC) &_sceptre_rpt_spa_full_cpp, 8},
    {"_sceptre_prepare_rpt_spa_response_cpp", (DL_FUNC) &_sceptre_prepare_rpt_spa_response_cpp, 6},
    {"_sceptre_release_rpt_spa_response_cpp", (DL_FUNC) &_sceptre_release_rpt_spa_response_cpp, 1},
    {"_sceptre_rpt_spa_moment_null_evaluation_cpp", (DL_FUNC) &_sceptre_rpt_spa_moment_null_evaluation_cpp, 4},
    {"_sceptre_rpt_spa_moment_prepared_cpp", (DL_FUNC) &_sceptre_rpt_spa_moment_prepared_cpp, 10},
    {"_sceptre_rpt_spa_moment_outward_prepared_cpp", (DL_FUNC) &_sceptre_rpt_spa_moment_outward_prepared_cpp, 8},
    {"_sceptre_rpt_spa_count_profile_cpp", (DL_FUNC) &_sceptre_rpt_spa_count_profile_cpp, 3},
