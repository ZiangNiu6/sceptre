construct_data_frame_v2 <- function(curr_df, curr_response_result, output_amount) {
  ...
  if (output_amount >= 2L) {
    ...
    optional_diagnostic_types <- list(
      ...
      spa_fast = NA,
      spa_cgf_mode = NA_character_,
      spa_cache_strategy = NA_character_,
      spa_solver_tolerance = NA_real_,
      spa_compressed_tolerance = NA_real_,
      spa_exact_audit_tolerance = NA_real_,
      spa_moment_degree = NA_integer_,
      spa_packed_moment_count = NA_integer_,
      spa_acceleration_path = NA_character_,
      spa_acceleration_fallback_reason = NA_character_,
      spa_moment_eligible = NA,
      spa_exact_audit_passed = NA,
      spa_converged = NA,
      ...
      spa_r_lr = NA_real_,
      spa_q_lr = NA_real_,
      spa_count_tilt = NA_real_,
      spa_count_residual = NA_real_,
      spa_count_variance_ratio = NA_real_,
      spa_count_berry_esseen_ratio = NA_real_,
      spa_conditional_rate_correction = NA_real_,
