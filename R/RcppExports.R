...
run_low_level_test_full_rpt_spa_v1 <- function(y, mu, a, w, D, Z, trt_idxs, n_trt, use_all_cells, synthetic_idxs, B1, B2, return_resampling_dist, side_code, use_moment = FALSE, prepared_context = NULL) {
    .Call(`_sceptre_run_low_level_test_full_rpt_spa_v1`, y, mu, a, w, D, Z, trt_idxs, n_trt, use_all_cells, synthetic_idxs, B1, B2, return_resampling_dist, side_code, use_moment, prepared_context)
}

run_low_level_test_full_rpt_spa_always_v1 <- function(y, mu, a, w, Z, trt_idxs, n_trt, side_code, max_iterations = 50L, use_moment = FALSE, prepared_context = NULL) {
    .Call(`_sceptre_run_low_level_test_full_rpt_spa_always_v1`, y, mu, a, w, Z, trt_idxs, n_trt, side_code, max_iterations, use_moment, prepared_context)
}
...
prepare_rpt_spa_response_cpp <- function(a, w, Z, zero_mask, minimum_zero_fraction = 0.8, maximum_moment_degree = 2L) {
    .Call(`_sceptre_prepare_rpt_spa_response_cpp`, a, w, Z, zero_mask, minimum_zero_fraction, maximum_moment_degree)
}
